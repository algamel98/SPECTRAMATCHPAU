...
var I18n = {
    ...
    translations: {
        en: {
            ...
            'align.section.title': 'Image Alignment Mode',
            'align.section.desc': 'Select preprocessing technique for image alignment before comparison analysis.',
            'align.mode.label': 'Alignment Technique',
            'align.mode.desc': 'Choose how images are aligned before pixel comparison',
            'align.studio.label': 'SPACTRA Studio',
            'align.studio.desc': 'Test and compare techniques visually before applying',
            'align.open.studio': 'Open Studio',
            'align.studio.title': 'SPACTRA Studio',
            'align.studio.subtitle': 'Test and compare alignment techniques interactively',
            'align.techniques': 'Alignment Techniques',
            'align.name.direct': 'Direct Pixel Comparison',
            'align.name.orb_homography': 'Feature-Based Alignment',
            'align.name.ecc_alignment': 'Intensity-Based Alignment (ECC)',
            'align.name.phase_correlation': 'Phase Correlation Alignment',
            'align.name.ai_smart_match': 'AI Smart Region Matching',
            'align.name.cascading_ecc': 'Cascading ECC Registration',
            'align.name.orb_affine': 'ORB Affine Alignment',
            'align.name.subpixel_translation': 'Subpixel Translation',
            'align.name.pyramid_align': 'Pyramid Coarse-to-Fine',
            'align.name.tile_refine': 'Tile-Based Local Refinement',
            'align.desc.direct': 'Original mode with no preprocessing. Compares images pixel-by-pixel as captured. Best when capture conditions are perfectly controlled.',
            'align.desc.orb_homography': 'Uses ORB feature detection with RANSAC homography to correct perspective distortion, rotation, and scale differences.',
            'align.desc.ecc_alignment': 'Enhanced Correlation Coefficient method. Iteratively optimizes an affine transform to maximize correlation between images.',
            'align.desc.phase_correlation': 'FFT-based method that detects translation and rotation by analyzing phase spectrum. Very fast and effective.',
            'align.desc.ai_smart_match': 'Custom intelligent algorithm combining multi-scale template matching, feature-guided refinement, and adaptive geometric correction.',
            'align.desc.cascading_ecc': 'Two-stage ECC: first locks translation, then refines with affine if needed. More stable than single-pass ECC on repetitive textures.',
            'align.desc.orb_affine': 'ORB features with RANSAC, preferring affine over homography. More constrained and stable for fabric shifts.',
            'align.desc.subpixel_translation': 'Pure X/Y shift correction using phase correlation with subpixel precision. Fastest technique — ideal for translation-only shifts.',
            'align.desc.pyramid_align': 'Multi-scale ECC pyramid: estimates rough alignment at low resolution, then refines at full resolution. Very robust for repetitive patterns.',
            'align.desc.tile_refine': 'Global ECC translation followed by per-tile phase correlation refinement. Corrects residual local misalignment after global shift.',
            'align.badge.rotation': 'Rotation',
            'align.badge.scale': 'Scale',
            'align.badge.translation': 'Translation',
            'align.badge.perspective': 'Perspective',
            'align.badge.lighting': 'Lighting',
            'align.badge.shear': 'Shear',
            'align.test': 'Test',
            'align.apply': 'Apply',
            'align.preview.side': 'Side by Side',
            'align.preview.overlay': 'Overlay',
            'align.preview.diff': 'Difference',
            'align.preview.checker': 'Checkerboard',
            'align.preview.empty': 'Select a technique and click Test to preview',
            'align.preview.empty.hint': 'Upload both images first, then test alignment methods here',
            'align.processing': 'Processing alignment...',
            'align.metrics.hint': 'Metrics will appear here after testing',
            'align.footer.note': 'Click a technique to auto-test it. Use Apply \u0026 Close to confirm your choice.',
            'align.cancel': 'Cancel',
            'align.confirm': 'Apply \u0026 Close',
            'align.confirmed': 'Applied!',
            'align.reference': 'Reference',
            'align.sample': 'Sample',
            'align.aligned': 'Aligned Sample',
            'align.overlay.label': 'Overlay (50% Blend)',
            'align.diff.before': 'Before Alignment',
            'align.diff.after': 'After Alignment',
            'align.checker.label': 'Checkerboard Interleave',
            'align.no.images': 'Please upload both images first',
            'align.test.success': 'Technique tested successfully',
            'align.test.failed': 'Test failed',
            'align.test.error': 'Error testing technique: ',
            'align.applied': 'Technique applied: ',
            'align.status.applied': 'Applied',
            'align.status.not.applied': 'Not Applied',
            'align.rotation': 'Rotation',
            'align.scale': 'Scale',
            'align.shift': 'Shift',
            'align.correlation': 'Correlation',
            'align.quality': 'Quality',
            'align.lighting': 'Lighting \u0394',
            'align.matches': 'Matches',
            'align.name.bestch': 'BESTCH — Best Matching Region',
            'align.desc.bestch': 'Searches for the most similar ~25% region between both images. Finds the best matching region anywhere in the sample — positions can differ. Returns both cropped regions for analysis.',
            'align.badge.cropping': 'Cropping',
            'align.ref.cropped': 'Cropped Reference',
            'align.sample.cropped': 'Cropped Sample',
            'align.bestch.low.title': 'Low Similarity Detected',
            'align.bestch.low.msg': 'The similarity between the matched regions is too low for reliable comparison. You can proceed with lower similarity or try another alignment technique.',
            'align.bestch.similarity': 'Similarity',
            'align.bestch.area': 'Matched Area',
            'align.bestch.crop': 'Crop Size',
            'align.bestch.try.other': 'Try Another Technique',
            'align.bestch.proceed': 'Proceed Anyway',
            'align.bestch.proceeding': 'Proceeding with low similarity match',
            'align.calibration': 'Calibration',
            'align.calibrating': 'Calibrating...',
            'align.calibrating.all': 'Running calibration on all techniques...',
            'align.calibration.complete': 'Calibration complete!',
            'align.calibration.done': 'All techniques tested. You can now download the calibration report.',
            'align.calibration.run.first': 'Please run calibration first',
            'align.download.calibration': 'Download Calibration Report',
            'align.report.generating': 'Generating...',
            'align.report.success': 'Calibration report downloaded',
            'align.report.error': 'Error generating report: ',
            'desktop.alignment.mode': 'Alignment Mode',
            'desktop.alignment.studio': 'SPACTRA Studio',
            'desktop.open.studio': 'Open Studio',
            'desktop.processing.report': 'Processing Report',
            'desktop.process.download': 'Process & Download Report',
            ...
            'align.images.required.msg': 'Please upload both a reference and a sample image before opening SPACTRA Studio.',
            'align.images.required.msg.single': 'Please upload an image before opening SPACTRA Studio',
            ...
            'thresholds.delta.e': 'Thresholds (DeltaEP2000%)',
            ...
            'rpt.deltaep2000.note': 'DeltaEP2000% is a percentage score derived from ΔE 2000: Score = max(0, min(100, 100 − mean(ΔE₂₀₀₀) × 10)). Unlike raw ΔE 2000 (which is an absolute perceptual distance with no upper bound), DeltaEP2000% maps it to a 0–100 scale for scoring purposes only.',
        ...
        tr: {
            ...
            // SPACTRA Studio (v3.0.0)
            'align.section.title': 'Görüntü Hizalama Modu',
            'align.section.desc': 'Karşılaştırma analizinden önce görüntü hizalama için ön işleme tekniği seçin.',
            'align.mode.label': 'Hizalama Tekniği',
            'align.mode.desc': 'Piksel karşılaştırmadan önce görüntülerin nasıl hizalanacağını seçin',
            'align.studio.label': 'SPACTRA Studio',
            'align.studio.desc': 'Uygulamadan önce teknikleri görsel olarak test edin ve karşılaştırın',
            'align.open.studio': 'Stüdyoyu Aç',
            'align.studio.title': 'SPACTRA Studio',
            'align.studio.subtitle': 'Hizalama tekniklerini etkileşimli olarak test edin ve karşılaştırın',
            'align.techniques': 'Hizalama Teknikleri',
            'align.name.direct': 'Doğrudan Piksel Karşılaştırma',
            'align.name.orb_homography': 'Özellik Tabanlı Hizalama',
            'align.name.ecc_alignment': 'Yoğunluk Tabanlı Hizalama (ECC)',
            'align.name.phase_correlation': 'Faz Korelasyonu Hizalama',
            'align.name.ai_smart_match': 'AI Akıllı Bölge Eşleştirme',
            'align.name.cascading_ecc': 'Kademeli ECC Kaydı',
            'align.name.orb_affine': 'ORB Afin Hizalama',
            'align.name.subpixel_translation': 'Alt Piksel Öteleme',
            'align.name.pyramid_align': 'Piramit Kaba-İnce Hizalama',
            'align.name.tile_refine': 'Karo Tabanlı Yerel İyileştirme',
            'align.desc.direct': 'Ön işleme yapılmadan orijinal mod. Görüntüleri çekildiği gibi piksel piksel karşılaştırır.',
            'align.desc.orb_homography': 'Perspektif bozulması, döndürme ve ölçek farklılıklarını düzeltmek için RANSAC homografi ile ORB özellik algılama kullanır.',
            'align.desc.ecc_alignment': 'Geliştirilmiş Korelasyon Katsayısı yöntemi. Görüntüler arasındaki korelasyonu en üst düzeye çıkarmak için afin dönüşümünü optimize eder.',
            'align.desc.phase_correlation': 'Faz spektrumunu analiz ederek öteleme ve döndürmeyi algılayan FFT tabanlı yöntem. Çok hızlı ve etkili.',
            'align.desc.ai_smart_match': 'Çoklu ölçekli şablon eşleştirme, özellik kılavuzlu iyileştirme ve uyarlanabilir geometrik düzeltmeyi birleştiren özel akıllı algoritma.',
            'align.desc.cascading_ecc': 'İki aşamalı ECC: önce ötelemeyi kilitler, ardından gerekirse afin ile iyileştirir. Tekrarlayan dokularda daha kararlıdır.',
            'align.desc.orb_affine': 'RANSAC ile ORB özellikleri, homografi yerine afin dönüşümü tercih eder. Kumaş kaymaları için daha kararlıdır.',
            'align.desc.subpixel_translation': 'Alt piksel hassasiyetle faz korelasyonu kullanarak saf X/Y kayma düzeltmesi. En hızlı teknik — yalnızca öteleme için idealdir.',
            'align.desc.pyramid_align': 'Çok ölçekli ECC piramidi: düşük çözünürlükte kaba hizalama, ardından tam çözünürlükte iyileştirme. Tekrarlayan desenler için çok dayanıklıdır.',
            'align.desc.tile_refine': 'Genel ECC ötelemesi ardından karo başına faz korelasyonu iyileştirmesi. Genel kaymadan sonra kalan yerel bozukluğu düzeltir.',
            'align.badge.rotation': 'Döndürme',
            'align.badge.scale': 'Ölçek',
            'align.badge.translation': 'Öteleme',
            'align.badge.perspective': 'Perspektif',
            'align.badge.lighting': 'Aydınlatma',
            'align.badge.shear': 'Kesme',
            'align.test': 'Test',
            'align.apply': 'Uygula',
            'align.preview.side': 'Yan Yana',
            'align.preview.overlay': 'Üst Üste',
            'align.preview.diff': 'Fark',
            'align.preview.checker': 'Dama Tahtası',
            'align.preview.empty': 'Önizleme için bir teknik seçin ve Test\'e tıklayın',
            'align.preview.empty.hint': 'Önce her iki görüntüyü yükleyin, ardından hizalama yöntemlerini burada test edin',
            'align.processing': 'Hizalama işleniyor...',
            'align.metrics.hint': 'Metrikler test sonrasında burada görünecek',
            'align.footer.note': 'Test etmek için bir tekniğe tıklayın. Seçiminizi onaylamak için \'Onayla ve Kapat\'a tıklayın.',
            'align.cancel': 'İptal',
            'align.confirm': 'Onayla ve Kapat',
            'align.confirmed': 'Uygulandı!',
            'align.reference': 'Referans',
            'align.sample': 'Numune',
            'align.aligned': 'Hizalanmış Numune',
            'align.overlay.label': 'Üst Üste (%50 Karışım)',
            'align.diff.before': 'Hizalama Öncesi',
            'align.diff.after': 'Hizalama Sonrası',
            'align.checker.label': 'Dama Tahtası Serpiştirilmiş',
            'align.no.images': 'Lütfen önce her iki görüntüyü yükleyin',
            'align.test.success': 'Teknik başarıyla test edildi',
            'align.test.failed': 'Test başarısız',
            'align.test.error': 'Teknik test hatası: ',
            'align.applied': 'Teknik uygulandı: ',
            'align.status.applied': 'Uygulandı',
            'align.status.not.applied': 'Uygulanmadı',
            'align.rotation': 'Döndürme',
            'align.scale': 'Ölçek',
            'align.shift': 'Kaydırma',
            'align.correlation': 'Korelasyon',
            'align.quality': 'Kalite',
            'align.lighting': 'Aydınlatma \u0394',
            'align.matches': 'Eşleşmeler',
            'align.name.bestch': 'BESTCH — En İyi Eşleşen Bölge',
            'align.desc.bestch': 'Her iki görüntü arasında en benzer ~%25 bölgeyi arar. Numunede en iyi eşleşen bölgeyi herhangi bir konumda bulur. Her iki kırpılmış bölgeyi analiz için döndürür.',
            'align.badge.cropping': 'Kırpma',
            'align.ref.cropped': 'Kırpılmış Referans',
            'align.sample.cropped': 'Kırpılmış Numune',
            'align.bestch.low.title': 'Düşük Benzerlik Tespit Edildi',
            'align.bestch.low.msg': 'Eşleşen bölgeler arasındaki benzerlik güvenilir karşılaştırma için çok düşük. Düşük benzerlikle devam edebilir veya başka bir hizalama tekniği deneyebilirsiniz.',
            'align.bestch.similarity': 'Benzerlik',
            'align.bestch.area': 'Eşleşen Alan',
            'align.bestch.crop': 'Kırpma Boyutu',
            'align.bestch.try.other': 'Başka Teknik Dene',
            'align.bestch.proceed': 'Yine de Devam Et',
            'align.bestch.proceeding': 'Düşük benzerlik eşleşmesiyle devam ediliyor',
            'align.calibration': 'Kalibrasyon',
            'align.calibrating': 'Kalibre ediliyor...',
            'align.calibrating.all': 'Tüm tekniklerde kalibrasyon çalıştırılıyor...',
            'align.calibration.complete': 'Kalibrasyon tamamlandı!',
            'align.calibration.done': 'Tüm teknikler test edildi. Kalibrasyon raporunu indirebilirsiniz.',
            'align.calibration.run.first': 'Lütfen önce kalibrasyonu çalıştırın',
            'align.download.calibration': 'Kalibrasyon Raporunu İndir',
            'align.report.generating': 'Oluşturuluyor...',
            'align.report.success': 'Kalibrasyon raporu indirildi',
            'align.report.error': 'Rapor oluşturma hatası: ',
            'desktop.alignment.mode': 'Hizalama Modu',
            'desktop.alignment.studio': 'SPACTRA Studio',
            'desktop.open.studio': 'Stüdyoyu Aç',
            'desktop.processing.report': 'İşleme Raporu',
            'desktop.process.download': 'İşle ve Rapor İndir',
            ...
            'align.images.required.msg': 'SPACTRA Studio\'yu açmadan önce lütfen hem referans hem de örnek görüntü yükleyin.',
            'align.images.required.msg.single': 'SPACTRA Studio\'yu açmadan önce lütfen bir görüntü yükleyin',
            ...
            'thresholds.delta.e': 'Eşikler (DeltaEP2000%)',
            ...
            'rpt.deltaep2000.note': 'DeltaEP2000%, ΔE 2000\'den türetilen bir yüzde puanıdır: Puan = max(0, min(100, 100 − ortalama(ΔE₂₀₀₀) × 10)). Ham ΔE 2000\'den (üst sınırı olmayan mutlak algısal mesafe) farklı olarak, DeltaEP2000% yalnızca puanlama amacıyla bunu 0–100 ölçeğine eşler.',
