...
### Output
```
installer\output\SpectraMatch_Setup_3.0.0.exe
```
...
```bash
DESKTOP_INSTALLER_URL=https://github.com/yourname/spectramatch/releases/download/v3.0.0/SpectraMatch_Setup_3.0.0.exe
```
