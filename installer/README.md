...
### Output
```
installer\output\SpectraMatch_Setup_2.2.3.exe
```
...
```bash
DESKTOP_INSTALLER_URL=https://github.com/yourname/spectramatch/releases/download/v2.2.3/SpectraMatch_Setup_2.2.3.exe
```
